...
class _HospitalsScreenState extends State<HospitalsScreen> {
  Future<Hospital> getData() async {
    final response = await http.get(
        Uri.parse('http://eibtekone-001-site3.atempurl.com/api/GetAllHospitalDates'));
              ...
              body: SingleChildScrollView(
                child: Stack(
                  children: [
                    ...
                    Center(
                      child: Padding(
                        padding: EdgeInsets.only(top: 100.h, right: 10.r, left: 10.r),
                        child: Column(
                                            ...
                                            rows:  List.generate(snapshot.data!.records!.length , (index) =>  DataRow(
                                                ...
                                                cells: [
                                                  ...
                                                  DataCell(Text(
                                                    ...
                                                    style: TextStyle( fontSize: 8.5.sp,height: 1.h),
                                                  )),
                                                  DataCell(Text(
