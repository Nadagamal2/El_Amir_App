...
class _PassportScreenState extends State<PassportScreen> {
  Future<passport> getData() async {
    final response = await http.get(
        Uri.parse('http://eibtekone-001-site3.atempurl.com/api/GetAllPassports'));
                                  ...
                                  child: ListView.separated(
                                      itemBuilder: (context,index)=>Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Padding(
                                              padding:   EdgeInsets.only(right:40.h,left: 40.h),                                              child: Container(
                                                height: 210.h,
                                                width: double.infinity,
                                                                      ...
                                                                      child: Container(
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            image: DecorationImage(
                                                                              ...
                                                                              image:  NetworkImage(
                                                                                'http://eibtekone-001-site3.atempurl.com${snapshot.data!.records![index].passImgUrl}',
                                                                              ),
                                                                            )
                                                                        ),
                                                                      )
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Column(
                                                          crossAxisAlignment: CrossAxisAlignment.center,
                                                          children: [
                                                            Text(  '${snapshot.data!.records![index].passNumber}',
                                                              style: TextStyle(
